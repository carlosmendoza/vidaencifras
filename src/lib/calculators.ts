...
export const calculadorasHerramientas: Calculadora[] = [
  ...
  {
    nombre: "Días Vividos",
    descripcion: "Descubre tu vida en números",
...
export const calculadorasFinanzas: Calculadora[] = [
  ...
  {
    nombre: "4x1000",
    descripcion: "Calcula el impuesto a movimientos financieros",
  ...
  {
    nombre: "Inflación",
    descripcion: "Entiende cómo la inflación afecta tu dinero",
  ...
  {
    nombre: "Jubilación",
    descripcion: "Planifica tu retiro con tranquilidad",
  ...
  },
  {
    ...
    descripcion: "Cuánto ahorrar mensualmente para tu objetivo",
  ...
  },
  {
    ...
    descripcion: "Calcula tus descuentos como independiente",
  ...
  },
  {
    ...
    descripcion: "Organiza tu plata de forma simple y efectiva",
  ...
  },
  {
    ...
    descripcion: "Compara rendimientos de cuentas remuneradas",
