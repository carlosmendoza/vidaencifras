...
const registroFinanzas: CalculadoraMeta[] = [
  ...
  },
  {
    ...
    faqs: [
      { question: "¿Cómo se calcula la cuota mensual de un préstamo?", answer: "La cuota mensual se calcula usando la fórmula del sistema francés: Cuota = P × [r(1+r)^n] / [(1+r)^n - 1], donde P es el monto del préstamo, r es la tasa de interés mensual (tasa anual dividida entre 12 y entre 100) y n es el número total de cuotas. Por ejemplo, para un préstamo de $10.000.000 al 18% anual a 36 meses, r = 0.015 y la cuota sería aproximadamente $361.520." },
      { question: "¿Qué es el sistema de amortización francés?", answer: "El sistema francés (o de cuota fija) es el más usado por bancos en Colombia para créditos de consumo, vehículo y libre inversión. Todas las cuotas son iguales durante la vida del crédito. En las primeras cuotas pagas más intereses y menos capital, pero esta proporción se invierte gradualmente. Su principal ventaja es la previsibilidad: sabes exactamente cuánto pagarás cada mes." },
      { question: "¿Qué incluye cada cuota del préstamo?", answer: "Cada cuota tiene dos componentes: el capital (que reduce el saldo de tu deuda) y los intereses (el costo que cobra el banco por prestarte el dinero). En el sistema francés, la suma de ambos siempre da la misma cuota. A medida que avanza el préstamo, la porción de capital aumenta y la de intereses disminuye, porque los intereses se calculan sobre el saldo pendiente." },
      { question: "¿Cómo puedo pagar menos intereses en un préstamo?", answer: "Las estrategias más efectivas son: 1) Elegir un plazo más corto (cuotas más altas pero mucho menos intereses totales). 2) Hacer abonos extraordinarios al capital cuando tengas dinero extra. 3) Comparar tasas en al menos 3 entidades antes de firmar. 4) Negociar la tasa si tienes buen historial crediticio. 5) Considerar compra de cartera si ya tienes un crédito con tasa alta." },
      { question: "¿Cuál es la diferencia entre tasa nominal y tasa efectiva?", answer: "La tasa nominal es la que el banco anuncia (ej: 1.5% mensual). La tasa efectiva anual (EA) incluye el efecto de la capitalización de intereses (interés sobre interés). Un 1.5% mensual nominal equivale a aproximadamente 19.56% EA. En Colombia, la Superfinanciera exige que los bancos informen la tasa EA para que puedas comparar créditos de forma justa." },
      { question: "¿Qué es la tasa de usura en Colombia?", answer: "La tasa de usura es el límite máximo legal que pueden cobrar las entidades financieras. Es certificada trimestralmente por la Superintendencia Financiera y equivale a 1.5 veces el interés bancario corriente. Cobrar por encima de la tasa de usura es un delito penal en Colombia (artículo 305 del Código Penal). Las tarjetas de crédito suelen tener tasas cercanas a este límite." },
      { question: "¿Me pueden cobrar penalización por pagar anticipado?", answer: "No. En Colombia, por ley (Ley 1555 de 2012), las entidades financieras no pueden cobrar penalización por pago anticipado en créditos de consumo, créditos de vivienda ni tarjetas de crédito. Puedes hacer abonos extra al capital o pagar la totalidad del crédito en cualquier momento sin costo adicional." },
      { question: "¿Qué es una tabla de amortización y para qué sirve?", answer: "La tabla de amortización es el detalle mes a mes de tu préstamo. Muestra para cada cuota cuánto va a capital, cuánto a intereses y cuál es el saldo pendiente. Es útil para: planificar tu presupuesto, saber cuánto debes en cualquier momento, decidir cuándo hacer abonos extra (al inicio tiene más impacto) y verificar que el banco esté calculando correctamente tus cuotas." },
    ],
  ...
  },
  {
    ...
    faqs: [
      { question: "¿Qué descuentos se hacen al salario en Colombia?", answer: "Los descuentos obligatorios son: salud (4%) y pensión (4%), ambos calculados sobre el salario básico. Si ganas más de 4 SMMLV ($7.003.620 en 2026), también se descuenta el Fondo de Solidaridad Pensional (1% adicional). Si tu salario es alto y supera el umbral gravable (95 UVT), se aplica retención en la fuente como anticipo del impuesto de renta." },
      { question: "¿El auxilio de transporte tiene descuentos?", answer: "No. El auxilio de transporte ($249.095 en 2026) no tiene descuentos de salud ni pensión. Se suma íntegro al salario neto. Aplica para quienes ganan hasta 2 SMMLV ($3.501.810). Además, el auxilio se incluye en la base para calcular prestaciones sociales como prima y cesantías, lo cual te beneficia." },
      { question: "¿Qué es el Fondo de Solidaridad Pensional?", answer: "Es un aporte adicional que deben hacer los trabajadores que ganan 4 SMMLV o más ($7.003.620 en 2026). Es del 1% para salarios entre 4 y 16 SMMLV, y del 2% para salarios superiores a 16 SMMLV. Este dinero financia pensiones de adultos mayores en situación de pobreza que no cotizan al sistema." },
      { question: "¿La retención en la fuente se descuenta del salario?", answer: "Sí, pero solo aplica para salarios cuya base gravable supera las 95 UVT mensuales (generalmente desde 4.5 SMMLV). Es un anticipo del impuesto de renta que se descuenta mensualmente. El valor depende de tus deducciones: dependientes económicos (hasta 4), medicina prepagada, intereses de crédito de vivienda, aportes AFC y pensiones voluntarias. Puedes reducirla reportando estas deducciones a tu empleador." },
      { question: "¿Cuánto es el salario mínimo en Colombia en 2026?", answer: "El salario mínimo mensual legal vigente (SMMLV) en 2026 es de $1.750.905. Con auxilio de transporte de $249.095, el total devengado para un trabajador de salario mínimo es de $2.000.000. Después de descuentos de salud (4%) y pensión (4%), el salario neto es de aproximadamente $1.859.928." },
      { question: "¿Qué diferencia hay entre salario bruto y salario neto?", answer: "El salario bruto es el valor pactado en tu contrato laboral, antes de descuentos. El salario neto es lo que realmente recibes en tu cuenta bancaria después de descontar salud, pensión, fondo de solidaridad (si aplica) y retención en la fuente (si aplica). Cuando te ofrecen un empleo, el salario que mencionan casi siempre es el bruto. Por eso es importante calcularlo para saber cuánto recibirás realmente." },
      { question: "¿Qué pasa con mi salario si trabajo medio tiempo?", answer: "En Colombia, el salario mínimo aplica para jornada completa (46 horas semanales, o 42 desde 2026 por la ley de reducción de jornada). Si trabajas medio tiempo, tu salario puede ser proporcional, pero nunca inferior al mínimo por hora trabajada. Los descuentos de salud y pensión se calculan igual (4% cada uno sobre tu salario básico)." },
      { question: "¿Mi empleador puede descontarme más del 8% de mi salario?", answer: "Los descuentos obligatorios de ley son salud (4%) y pensión (4%), que suman 8%. Si ganas más de 4 SMMLV se agrega el Fondo de Solidaridad (1-2%). Además, puede haber retención en la fuente para salarios altos. Tu empleador NO puede hacer descuentos adicionales sin tu autorización escrita (como créditos de libranza, cooperativas, seguros voluntarios, etc.)." },
    ],
  ...
  },
  {
    ...
    faqs: [
      { question: "¿Qué incluye la liquidación laboral en Colombia?", answer: "La liquidación incluye todas las prestaciones sociales proporcionales al tiempo trabajado: prima de servicios (proporcional al semestre), cesantías (proporcionales al año), intereses sobre cesantías (12% anual), y vacaciones no disfrutadas (15 días hábiles por año). Si el despido es sin justa causa, también incluye indemnización. Además, puede incluir salarios pendientes de pago y bonificaciones pactadas." },
      { question: "¿Cuándo me deben pagar la liquidación?", answer: "El empleador debe pagar la liquidación al momento de la terminación del contrato laboral. Si no lo hace, se activa la sanción moratoria del artículo 65 del Código Sustantivo del Trabajo: un día de salario por cada día de retraso. Esta sanción aplica por un máximo de 24 meses; después de ese plazo, se causa interés moratorio." },
      { question: "¿Cómo se calcula la indemnización por despido sin justa causa?", answer: "Depende del tipo de contrato y el salario. Para contratos indefinidos con salario hasta 10 SMMLV: 30 días de salario por el primer año + 20 días por cada año adicional (o fracción). Para salarios superiores a 10 SMMLV: 20 días por el primer año + 15 días por cada año adicional. Para contratos a término fijo: el valor de los salarios que faltan hasta la fecha de vencimiento del contrato." },
      { question: "¿Si renuncio tengo derecho a liquidación?", answer: "Sí, siempre tienes derecho a la liquidación de prestaciones sociales (prima, cesantías, intereses y vacaciones), sin importar si renuncias o te despiden. Lo único que NO recibes al renunciar es la indemnización, ya que esta solo aplica cuando el empleador termina el contrato sin justa causa." },
      { question: "¿Cómo se calcula la prima de servicios en la liquidación?", answer: "La prima proporcional se calcula tomando los días trabajados en el semestre actual (enero-junio o julio-diciembre). La fórmula es: Prima = (Salario + Auxilio de transporte) × Días del semestre ÷ 360. Por ejemplo, si renuncias el 15 de marzo con salario mínimo, tu prima sería proporcional a 75 días del semestre." },
      { question: "¿Las cesantías se pagan directamente al trabajador en la liquidación?", answer: "Sí. En la liquidación, las cesantías proporcionales del año en curso se pagan directamente al trabajador. A diferencia de las cesantías de años anteriores (que el empleador consigna al fondo de cesantías antes del 14 de febrero), las del período de liquidación se entregan en efectivo o transferencia al momento del retiro." },
      { question: "¿Qué pasa si no estoy de acuerdo con el valor de mi liquidación?", answer: "Puedes firmar el documento de liquidación con la anotación 'no conforme' o 'con reserva' junto a tu firma. Esto te permite reclamar posteriormente ante un juez laboral o el Ministerio de Trabajo. Tienes un plazo de 3 años para iniciar acciones legales por derechos laborales (artículo 488 del CST). Es recomendable guardar copia de tu contrato, desprendibles de nómina y carta de terminación." },
      { question: "¿La liquidación paga impuestos?", answer: "Las prestaciones sociales (prima, cesantías, intereses) están exentas de retención en la fuente en la mayoría de casos. Las vacaciones compensadas sí pueden estar sujetas a retención si el valor supera ciertos umbrales. La indemnización por despido tiene un tratamiento tributario especial: está exenta hasta 3.250 UVT anuales. Consulta con un contador para tu caso específico." },
    ],
  ...
  },
  {
    ...
    meta: { title: "Calculadora Impuesto de Renta Colombia 2026 | Personas Naturales", description: "Calcula tu impuesto de renta en Colombia para personas naturales. Incluye tabla de tarifas actualizada, deducciones y retención en la fuente.", keywords: ["impuesto de renta colombia", "calculadora renta 2026", "declaración de renta", "personas naturales", "tabla impuesto renta", "UVT 2026", "retención en la fuente", "deducciones renta"] },
    ...
    faqs: [
      { question: "¿Quiénes deben declarar renta en Colombia?", answer: "Deben declarar renta las personas naturales cuyos ingresos brutos en el año gravable hayan sido iguales o superiores a 1.400 UVT (aproximadamente $73,3 millones en 2026), o que tengan un patrimonio bruto superior a 4.500 UVT al 31 de diciembre." },
      { question: "¿Qué es el UVT y para qué sirve?", answer: "La Unidad de Valor Tributario (UVT) es una medida de valor que permite ajustar automáticamente los valores en las normas tributarias. Para 2026, el UVT es de $52.374. Se actualiza cada año según la inflación." },
      ...
      { question: "¿Cuándo debo pagar el impuesto de renta?", answer: "Las personas naturales declaran y pagan entre agosto y octubre del año siguiente, según los dos últimos dígitos del NIT. Por ejemplo, para ingresos de 2025, se declara en 2026." },
    ],
    header: { title: "Calculadora de Impuesto de Renta", subtitle: "Estima tu impuesto de renta en Colombia para el año 2026" },
  },
  {
  ...
  },
  {
    ...
    meta: { title: "Calculadora de Retención en la Fuente Colombia 2026", description: "Calcula la retención en la fuente en Colombia. Servicios profesionales, honorarios, compras, arrendamientos. Tasas actualizadas 2026. Calcula el neto a recibir.", keywords: ["retención en la fuente Colombia", "calculadora retención", "retefuente servicios", "retención honorarios", "retención compras", "retención arrendamiento", "DIAN retención", "base retención fuente", "porcentaje retención", "calcular retención 2026"] },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "¿Cuál es la tasa de usura en Colombia?", answer: "La tasa de usura es el máximo interés legal que pueden cobrar las entidades financieras. Para 2026, ronda entre el 26% y 30% efectivo anual para tarjetas de crédito. La Superfinanciera la actualiza mensualmente." },
  ...
  },
  {
    ...
    meta: { title: "Comparador de Préstamos Colombia 2026 - Encuentra la Mejor Tasa", description: "Compara préstamos de los principales bancos en Colombia: Bancolombia, Davivienda, BBVA, Banco de Bogotá y más. Libre inversión, vehículo y vivienda. Tasas actualizadas 2026.", keywords: ["comparador préstamos Colombia", "mejor tasa préstamo", "préstamo libre inversión", "crédito vehículo Colombia", "crédito vivienda Colombia", "Bancolombia préstamos", "Davivienda crédito", "BBVA préstamo", "tasas préstamos 2026", "simulador crédito bancos"] },
  ...
  },
  {
    ...
    meta: { title: "Comparador de Cuentas de Ahorro Colombia | Mejores Tasas 2026", description: "Compara las mejores cuentas de ahorro en Colombia: Ualá, Nu, Pibank, Global66 y más. Simula rendimientos con interés compuesto y visualiza cuánto ganas vs guardar bajo el colchón.", keywords: ["cuentas de ahorro colombia", "mejor cuenta de ahorro", "comparador cuentas ahorro", "ualá colombia", "nu colombia cajitas", "pibank ahorro", "global66", "tasas de interés ahorro", "simulador ahorro", "interés compuesto"], ogTitle: "Comparador de Cuentas de Ahorro Colombia 2026", ogDescription: "Encuentra la mejor cuenta de ahorro en Colombia. Compara tasas de Ualá, Nu, Pibank y más." },
